  ...
  program
    ...
    .action(async () => {
      ...
      try {
        ...
        console.log(
          chalk.bold('Working tree: '),
          pre.isDirty ? chalk.yellow('dirty') : chalk.green('clean'),
        );
        console.log(
          chalk.bold('Untracked files: '),
          pre.hasUntracked ? chalk.yellow('yes') : chalk.green('no'),
        );
        console.log(
          chalk.bold('Ongoing operation: '),
          pre.ongoingMerge ? chalk.red('yes') : chalk.green('no'),
        );
        ...
        console.log(
          ...
          pre.lastFetchAgoSec == null
            ? chalk.gray('unknown')
            : chalk.cyan(`${pre.lastFetchAgoSec}s ago`),
        );
